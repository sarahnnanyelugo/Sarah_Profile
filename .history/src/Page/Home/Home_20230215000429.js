          ...
          <div className="col-md-6 offset-md-2 flexy">
            <div className="col-md-8 col-12">
              ...
              <p>
                ...
                and ability to do much more than we limit ourselves to. Thus,
                learning sotware development became my next feat. Pregnant with
                my first child, I launched myself into Software and never looked
                back. By the time we welcomed our baby, I had learnt HTML, CSS,
                Javascript and frameworks such as Bootstrap and jQuery. The full
                story of this is published on my
              </p>
            </div>
