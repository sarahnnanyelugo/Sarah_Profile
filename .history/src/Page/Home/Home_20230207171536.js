      ...
      <div className="col-md-12 about-me">
        <div className="col-md-6 offset-md-3">
          ...
          <div className="col-md-12 expe-container">
            <div>
              {/* <ol className="list-unstyled col-md-3">
                <li>
                  <a className="link-alteration" href="#">
              ...
              <ul className="list-unstyled col-md-9">
                <li>
                  Frontend Developer @{" "}
                  <a className="link-alteration" href="#">
                    SwitchApp Technologies
              ...
              <table>
                <tr>
                  <td>SwitchApp Technologies</td>
                  <td>
                    Frontend Developer @ SwitchApp Technologies
                    <br />
                    <small>
                      Collaborated in building the frontend of SwitchApp; A
                      payment gateway aggregator.
                  ...
                  <tr>
                    <td> Educare Technology Solutions</td>
                    <td>
                      {" "}
                      <a className="link-alteration" href="#">
                        Educare Technology Solutions
