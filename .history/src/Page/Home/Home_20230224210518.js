          ...
          <div className="col-md-6 offset-md-2 ">
            ...
            <div className="col-md-12 col-12 flexy">
              <p>
                ...
                but It was a skill I longed to acquire. It is true that most
                people see a career path as something you pick once and spend
                the rest of your working years excelling in that field. However,
                I am one of those who see career choices as a rather progressive
                decision, I believe that as humans, we have enough creativity
                and ability to do much more than we limit ourselves to. This was
                the school of thought that birthed my career in software
                development. By the end of 2020, I had learnt HTML, CSS,
                Javascript and frameworks such as Bootstrap and jQuery. This
                story is a little more elabourate than this. Interested?{" "}
                <a
