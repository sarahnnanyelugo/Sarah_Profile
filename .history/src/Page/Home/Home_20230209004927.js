  ...
  return (
    <>
      <div data-scroll-section>
          ...
          <div className="col-md-6 intro-container">
            ...
            >
              ...
              <p>
                ...
                experienced in leading cross-functional teams in a
                time-pressured setting to complete projects on schedule and
                within budget.
              </p>
            </MovingComponent>
          </div>
        ...
        <div className="col-md-12 about-me" data-scroll-section>
        ...
        <div className="col-md-12 about-me flexy" data-scroll-section>
