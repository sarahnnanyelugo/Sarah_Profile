  ...
  return (
    <>
      <div className="col-md-12 flexy">
        ...
        <div className="col-md-5 offset-md-1 intro-container">
          <img className="col-md-12 col-12" src={Avatar} alt="Scholar" />
          {/* <img className="col-md-7 col-12" src={Screen} alt="Scholar" /> */}
        </div>
      </div>
