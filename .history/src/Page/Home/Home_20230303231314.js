      ...
      <div className="col-md-12 ">
        ...
        <div className="col-md-12 about-me my-profile">
          ...
          <p className="col-md-6 offset-md-2">
            ...
            , a payment engine for the internet. This was my first official
            collaboration experience and it indeed was a great feat for me.
          </p>
          <p className="col-md-6 offset-md-2">
            {" "}
        ...
        <center style={{ color: "#fff", border: "solid 2px red" }}>
          {" "}
          My <Menu />
        </center>
        <div
