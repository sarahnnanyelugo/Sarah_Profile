        ...
        <div className="col-md-12 about-me ">
          <div className="col-md-6 offset-md-2 flexy">
            <div className="col-md-8 col-12">
              ...
              <p>
                {" "}
                Hello! my name is Sarah Nanyelugo. I am a frontend developer and
                I enjoy creating things that live on the internet. This overtime
                has made me passionate about digital products that help people
