...
export const Home = ({ active, children }) => {
  ...
  return (
    <>
      ...
      <div className="col-md-12 about-me" data-scroll data-scroll-speed="3">
      ...
      <div className="col-md-12 about-me" data-scroll data-scroll-speed="-3.75">
      ...
      <div
        className="col-md-12 about-me flexy"
        data-scroll
        data-scroll-speed="3"
      >
